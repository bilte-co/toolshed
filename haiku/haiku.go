...
var (
	...
	NOUNS = []string{
		"dog", "cat", "elephant", "tiger", "lion", "bear", "wolf", "fox", "rabbit", "deer", "horse", "cow", "pig", "goat", "sheep", "chicken", "duck", "goose", "turkey", "llama", "alpaca", "kangaroo", "koala", "panda", "zebra", "giraffe", "rhinoceros", "hippopotamus", "crocodile", "alligator", "snake", "lizard", "turtle", "tortoise", "frog", "toad", "salamander", "newt", "bat", "mouse", "rat", "squirrel", "beaver", "otter", "mole", "hedgehog", "skunk", "raccoon", "chimpanzee", "gorilla", "orangutan", "baboon", "lemur", "dolphin", "whale", "shark", "octopus", "squid", "jellyfish", "starfish", "crab", "lobster", "shrimp", "clam", "oyster", "mussel", "seahorse", "eel", "tuna", "salmon", "trout", "cod", "sardine", "anchovy", "pufferfish", "parrot", "eagle", "hawk", "falcon", "owl", "crow", "raven", "pigeon", "dove", "peacock", "flamingo", "swan", "stork", "pelican", "toucan", "woodpecker", "hummingbird", "canary", "finch", "robin", "bluejay", "magpie", "hyena", "jackal", "antelope", "bison", "buffalo", "reindeer", "moose", "elk", "caribou", "walrus", "seal", "sea-lion", "manatee", "dugong", "narwhal", "beluga", "orca", "sea-turtle", "stingray", "anemone", "sea-urchin", "sea-cucumber", "coral", "sea-sponge", "sea-fan", "sea-whip", "sea-lily", "sea-star", "apple", "banana", "orange", "pear", "mango", "pineapple", "papaya", "guava", "kiwi", "lychee", "grape", "blueberry", "strawberry", "raspberry", "blackberry", "cranberry", "watermelon", "cantaloupe", "honeydew", "peach", "plum", "nectarine", "apricot", "cherry", "fig", "pomegranate", "persimmon", "jackfruit", "durian", "passionfruit", "dragonfruit", "starfruit", "tamarind", "coconut", "avocado", "tomato", "cucumber", "zucchini", "eggplant", "bell pepper", "chili pepper", "pumpkin", "squash", "butternut squash", "acorn squash", "spaghetti squash", "carrot", "beet", "radish", "turnip", "parsnip", "potato", "sweet potato", "yam", "onion", "garlic", "shallot", "leek", "scallion", "celery", "fennel", "asparagus", "broccoli", "cauliflower", "cabbage", "kale", "spinach", "lettuce", "arugula", "swiss chard", "collard greens", "mustard greens", "brussels-sprouts", "okra", "corn", "green-bean", "snap-pea", "snow-pea", "edamame", "lima-bean", "chickpea", "black-bean", "kidney-bean", "pinto-bean", "navy-bean", "lentil", "soybean", "artichoke", "rhubarb", "kohlrabi", "jicama", "horseradish", "daikon", "chayote", "rutabaga", "cassava", "taro", "plantain", "olive", "date", "mulberry", "gooseberry", "currant", "sapote", "mangosteen", "rambutan", "longan", "salak", "soursop", "breadfruit", "rose-apple", "miracle fruit", "medlar", "loquat", "macadamia", "almond", "cashew", "walnut", "pecan", "hazelnut", "pistachio", "pine-nut", "chestnut", "brazil-nut", "betel-nut", "coconut-meat", "tiger nut", "water-chestnut", "sunflower-seed", "pumpkin-seed", "flaxseed", "sesame-seed", "chia-seed", "hemp-seed", "lotus-seed", "bamboo shoot", "seaweed", "nori", "spirulina", "wakame", "kelp", "cucumber melon", "bitter-melon",
	}
)
